// @ts-nocheck
// Datos migrados mecanicamente desde game.js. Mantener como fuente temporal hasta tipar el banco completo.
...
export const BASE_STATS = ["pace", "racecraft", "tyre", "technical", "focus"];
